export const en = {
  ...
  services: {
    ...
    cards: [
      ...
      },
      {
        ...
        description: "Stop fighting for clicks and start getting chosen. We optimize your brand so when people ask AI for help, it names your business as the primary solution.",
        cta: 'Learn More',
    ...
    secondRow: [
      {
        title: 'Customized Google Ads for Local SMBs & Global Manufacturers',
        description: 'Global Reach, Local Impact. We design tailored Google Ads strategies to maximize ROI for local SMBs and help Chinese manufacturers successfully penetrate the North American market. From budget optimization to full-scale market entry, we ensure your brand connects with high-intent buyers.',
        cta: 'Learn More',
      ...
      },
      {
        ...
        url: 'transparent-reporting',
      },
    ],
  },
  specialized: {
    title: 'We Are Different',
    description: "At Aivio Digital, we move beyond traditional marketing by treating your growth as a technical system to be engineered. Led by a Senior Software QA and IT Auditor with 10+ years of experience, we apply a rigorous auditing framework to \"debug\" your account architecture and ensure your data logic is leak-proof. As search shifts to AI, we engineer your footprint to win both the human click and the AI citation in generative search. By combining this data-driven logic with deep roots in international trade and trilingual expertise, we provide a systematic, evidence-based path to North American market dominance for B2B founders and global manufacturers.",
  },
  portfolio: {
    title: 'Portfolio',
    altPrefix: 'Portfolio',
  ...
  howItWorks: {
    ...
    subtitle: 'See what\'s working, fix what\'s not, and grow your leads.',
    audit: {
      step: '1',
      title: 'Audit',
      description: 'Identify what\'s driving results and what\'s draining your budget',
    },
    fixAndBuild: {
      step: '2',
      title: 'Fix & Build',
      description: 'Optimize campaign structure, tracking, and targeting for better performance',
    },
    manageAndOptimize: {
      step: '3',
      title: 'Manage & Optimize',
      description: 'Continuously improve ad performance and lead quality',
    },
    noContract: 'No long-term contracts. No pressure. Clear decisions at every step.',
  },
  testimonials: {
    title: 'What Our Clients Say',
    susanna: {
      quote: 'We were spending a lot on Google Ads but weren\'t seeing results. After working with Aivio Digital, they audited our campaigns, fixed tracking issues, and optimized our targeting. Within two months, our lead quality improved significantly, and our cost per lead dropped by over 30%! Highly recommend their professional approach and clear guidance.',
      name: 'Susanna',
      role: 'Owner, Custom Packaging Company',
    },
    jason: {
      quote: 'Running ads used to feel like throwing money into a black hole. Aivio Digital set up our Google Ads campaigns from scratch, including writing all the ad copy and optimizing targeting. Now we get consistent inquiries from serious clients, and the reporting is so transparent that we always know exactly how our budget is being used. Their service is top-notch.',
      name: 'Jason',
  ...
  caseStudyShort: {
    ...
    monthlySpend: '~CA$500',
    challenge: 'Budget spread across too many services, leads were inconsistent',
    solution: 'Solution',
    solution1: 'Focused on high-intent "custom packaging" keywords',
  ...
  contactUs: {
    ...
    servicesPricing: {
      ...
      geo: {
        title: 'AI Search Optimization (GEO)',
        description: 'Technical engineering of your digital footprint to secure citations and recommendations in generative search.',
        pricing: 'Pricing: Custom quote based on project scope.',
      },
